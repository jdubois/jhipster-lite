...
```
curl "https://nubesgen.com/jhipster-lite.tgz?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.standard&runtime=SPRING&database=NONE.free&addons=application_insights&addons=storage_blob&gitops=true" | tar -xzvf -
```
