...
```
curl "https://nubesgen.com/jhipster-lite.tgz?iactool=TERRAFORM&region=northeurope&application=APP_SERVICE.standard&runtime=SPRING&database=NONE.free&addons=application_insights&gitops=true" | tar -xzvf -
```
